...
export const categories = pgTable('categories', {
  ...
  // nameFr ve nameEn kolonları sadece POST/PUT endpoint'lerinde manuel SQL ile kullanılıyor
  // Schema'da tanımlı değil çünkü veritabanında olmayabilir
...
export const products = pgTable('products', {
  ...
  packLabelTr: varchar('pack_label_tr', { length: 50 }),
  packLabelEn: varchar('pack_label_en', { length: 50 }),
  packLabelFr: varchar('pack_label_fr', { length: 50 }),
  images: text('images'),
  isActive: boolean('is_active').default(true),
