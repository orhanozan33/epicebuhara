...
export default function BayiSatisPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 w-full overflow-x-hidden">
      <div className="max-w-7xl mx-auto w-full min-w-0">
        {/* Header */}
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full min-w-0">
          {/* Sol Taraf - Ürünler */}
          <div className="lg:col-span-2 bg-white rounded-lg shadow p-4 md:p-6 w-full min-w-0 overflow-x-hidden">
            {/* Arama */}
          ...
          <div className="lg:col-span-1 bg-white rounded-xl shadow-lg border-2 border-gray-100 p-4 md:p-6 w-full min-w-0 overflow-x-hidden">
