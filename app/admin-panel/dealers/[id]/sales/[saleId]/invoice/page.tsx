...
export default function FaturaPage() {
  ...
  const handleMarkShipped = async () => {
    ...
    try {
      ...
      showToast(mounted ? t('admin.dealers.shipped') : 'Marked as shipped.', 'success');
    } catch (error: any) {
      showToast(error?.message || (mounted ? t('admin.common.error') : 'Error'), 'error');
    } finally {
    ...
    <div className="min-h-screen print:min-h-0 bg-gray-100 p-2 lg:p-8 print:p-4 print:mt-0 print:bg-white w-full overflow-x-auto" style={{ maxWidth: '100%', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div className="mb-4 lg:mb-6 print:hidden flex gap-2 lg:gap-3 items-center justify-center">
        ...
        {!sale.isShipped && (
          ...
          >
            {markingShipped ? (mounted ? t('admin.common.loading') : '...') : `✅ ${mounted ? t('admin.dealers.markShipped') : 'Gönderildi'}`}
          </button>
        )}
      </div>
